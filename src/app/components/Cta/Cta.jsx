...
export default function Cta(){
    const contact = ["mailto:joshuajosh3055@gmail.com", "tel:+91 7259987691", "https://github.com/Zynxx777", "https://www.linkedin.com/joshua-d8155a8228"];
    ...
    <div className="grid mt-24 xl:grid-cols-1 xl:grid-rows-1 justify-stretch grid-cols-7 grid-rows-2 gap-8  rounded-[64px]">
        ...
        <div className="dark:bg-[#12121285] bg-slate-100 xl:col-span-1 col-span-4 rounded-[40px] flex flex-col justify-between py-5 px-5 outline-1 outline outline-offset-4 outline-black/20 dark:outline-white/20 ">
           ...
           {t('place1')} <br/>{t('place2')} 🤙🏾
            ...
            <div className="flex gap-4">
                <a href="mailto:joshuajosh3055@gmail.com" target="_blank" className="size-9 group w-20 rounded-full  duration-500 p-1 bg-[#54daff]  hover:betterhover:opacity-70">
                    <div style={{maskImage: `url("images/mail.svg")`, maskSize: 'auto'}} className="block size-full  bg-white svgMask"></div>
                </a>
                <a href="tel:+91 7259987691" className="size-9 w-20 group rounded-full  duration-500 p-1 bg-[#a64ca6]  hover:betterhover:opacity-70">
                    <div style={{maskImage: `url("images/phone.svg")`, maskSize: 'auto'}} className="block size-full bg-white svgMask"></div>
                </a>
                <a href="https://wa.me/7259987691" target="_blank" className="size-9 w-20 transition-all duration-500 bg-[#25d366]  hover:betterhover:opacity-70 rounded-full p-1 group cursor-pointer">
        ...
        <div className="dark:bg-[#12121285] bg-slate-100 text-2xl p-5 size-full col-span-3 xl:col-span-1 rounded-[40px] outline-1 outline outline-offset-4 outline-black/20 dark:outline-white/20 ">
            ...
            <div className="flex gap-6 size-full py-4">
                <a href="https://www.linkedin.com/in/joshua-d8155a8228" target="_blank" className="size-[90%]  duration-300  bg-[rgb(10,102,194)] transition-all hover:betterhover:opacity-70  outline rounded-[30px] p-4">
