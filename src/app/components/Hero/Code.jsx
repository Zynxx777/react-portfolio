...
export default function Code(){
      ...
      export default function Projects() {     
          const projects = [
              ...
              {name: 'business oriented website',img: '/images/discord_clone.jpg', link: 'https://zynxx777.github.io/darkpanZ/', description: 'a business growth focused website  :)', skills: ['bootstrap','scss','html','next', 'tailwind', 'ts']},
