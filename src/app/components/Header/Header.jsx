  ...
  return (<motion.header initial={{y: -50}} animate={{y: 0}} className="fixed top-0 w-full p-2 px-5 z-50  backdrop-blur-sm mx-[-130px] xl:mx-[-30px] xs:-mx-2">
      ...
      {/* <div className="absolute backdrop-blur-3xl size-full top-0"></div> */}
        ...
        <li className="cursor-pointer">
              ...
              <li>
                <a href="https://www.linkedin.com/in/joshua-d8155a8228/"  target="_blank" className='group'><span style={{maskImage: `url("/images/linkedin.svg")`}} className="block mx-auto size-[18px] bg-black  dark:bg-white svgMask group-hover:opacity-80 cursor-pointer"></span> </a>
              </li> */}
